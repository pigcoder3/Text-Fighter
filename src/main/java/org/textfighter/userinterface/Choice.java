...
public class Choice {
    ...
    public void invokeMethod() {
        try { method.invoke(arguments); } catch (IllegalAccessException | InvocationTargetException e) { e.printStackTrace(); }
    }

    public Choice(String name, String description, String method, ArrayList<String> arguments, ArrayList<Class> argumentTypes, String clazz, ArrayList<ChoiceRequirement> requirements) {
        this.name = name;
